...
import qa.guru.helpers.CustomApiListener;
...
//                    .extract().cookies();
////                    .extract().cookie();
////            String cardCookieValue1 = given()
////                    .post("/card")
////                    .then()
////                    .log().all()
////                    .statusCode(200)
////                    .extract().cookie(cardCookieName);;
//
//            step("Open minimal content, because cookie can be set when site is opened", () -> {
//                open("/Themes/DefaultClean/Content/images/logo.png");
//            });
//            step("Set cookie to browser", () -> {
////                Cookie cardCookie = new Cookie(cardCookieName, cardCookieValue);
////                WebDriverRunner.getWebDriver().manage().addCookie(cardCookie);
//            });
//        });
//        step("Item added to cart", () -> {
//            open("/cart");
